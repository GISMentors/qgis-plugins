...
.. index::
    single: Python
    single: programovací jazyk Python

`Python <http://python.org>`_ je  je moderní programovací jazyk. Je univerzální
- pohání weby, rakety i GISy.  Dobře se čte a dá se velice rychle naučit. Je
  skvělý pro výuku programování.  `Česká komunita <http://python.cz>`_ je
  aktivní a najdete v ní pomoc, kamarády i práci.
...
.. tip::
   ...
   <./skoleni-qgis-plugins.pdf>`_.
   
.. important:: Školení je zaměřeno na aktuální *testing* verzi
               `QGIS 3.0.2 <https://docs.qgis.org/testing/en/docs/>`_.
               U jiných verzích není zaručena funkčnost uvedených příkladů. Dále
...
Pro víc informací o QGIS navštivte prosím naše `školení pro začátečníky
<http://training.gismentors.eu/qgis-zacatecnik>`_.
