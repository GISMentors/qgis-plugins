...
Add multiple layers to your new QGIS project
...
activate the `save_views` plugin.
...
and open the :file:`save_views_dockwidget_base.ui` file.
...
.. note:: The code can be downloaded from
          https://github.com/GISMentors/qgis-plugins/tree/master/src/save_views-01-init
